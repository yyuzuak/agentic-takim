...
- **NATS JetStream subject'leri sabit (9):** `ACP.TASK.CREATED`, `ACP.TASK.COMPLETED`, `ACP.TASK.FAILED`, `ACP.TASK.DLQ`, `ACP.TOOL.REQUEST`, `ACP.TOOL.RESULT`, `ACP.HANDOFF.REQUESTED`, `ACP.AGENT.HEARTBEAT`, `ACP.SYSTEM.EVENT`.
